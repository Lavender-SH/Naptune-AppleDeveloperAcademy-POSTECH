            ...
            ZStack {
                ...
                VStack {
                    ...
                    VStack{
                        ...
                        NavigationLink(
                            destination: LavenderCheckSilentModeView(confirmAction: {
                        ...
                        NavigationLink(
                            destination: LavenderProgressView(remainingSeconds: $remainingSeconds, startTime: currentKSTTime(), endTime: wakeupTime()),
