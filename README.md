...
- **1. 낮잠 시간을 정하는 타이머 기능**</br>
- **2. 정해진 낮잠시간이 끝나면 CallKit으로 전화를 해주는 기능**</br>
- **3. 일어나기 버튼을 누르면 커스텀된 카메라로 이동하는 기능**</br>
- **4. 친구들의 낮잠 피드를 확인하는 기능**</br>
- **5. 다이나믹 아일랜드와 라이브 액티비티를 활용하여 백그라운드 모드에서도 남은 낮잠시간을 확인할 수 있는 기능**</br> 
